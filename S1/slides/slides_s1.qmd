...
- Léo & Émilien : ancrage SHS & recherche
- Vous
...
**Une définition**: utiliser des instructions (code/script) dans un langage (formalisé) pour faire réaliser (exécuter) à un ordinateur des actions.
...
## Un programme : une chaîne de différentes "briques"
...
## Dans les faits : une conception étendue
